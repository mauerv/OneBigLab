...
export default () => (
	<div className='fixed-bottom bg-primary p-4 d-flex justify-content-between pl-5 pr-5 flex-column flex-md-row'>
		<p className='text-light m-0 align-self-center d-none d-sm-block'>DAO Browser by <strong><a className='text-light' href='https://twitter.com/emivelazquez6' target='_blank'>emi</a></strong> and <strong><a className='text-light' href='https://twitter.com/MauroVelazquezz' target='_blank'>mauerv</a></strong>
		</p>
