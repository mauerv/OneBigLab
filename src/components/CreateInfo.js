	...
	<div className='container'>
		...
		<div className='row border-top border-bottom pt-5 pb-5 align-items-center'>
			...
			<div className='col-sm-3 offset-sm-1 d-none d-sm-block'>
				<img className='lg-thumbnail' src='moloch.png' />
			</div>
			<hr/>
		</div>
		...
		<div className='row border-top border-bottom pt-5 pb-5 align-items-center'>
			<div className='col-sm-3 d-none d-sm-block'>
				<img className='lg-thumbnail' src='aragon.jpg' />
			</div>
		...
		<div className='row border-top border-bottom pt-5 pb-5 align-items-center'>
			...
			<div className='col-sm-3 offset-sm-1 d-none d-sm-block'>
				<img className='lg-thumbnail' src='daostack.png' />
			</div>
		</div>

		<div className='row border-top border-bottom pt-5 pb-5 align-items-center'>
			<div className='col-sm-3 d-none d-sm-block'>
				<img className='lg-thumbnail' src='colony.png' />
			</div>
			<div className='col-12 col-sm-8 offset-sm-1 col-lg-8 offset-lg-0'>
				<h2>Colony</h2>
		...
		<div className='row border-top border-bottom pt-5 pb-5 align-items-center'>
			...
			<div className='col-sm-3 offset-sm-1 d-none d-sm-block'>
				<img className='lg-thumbnail' src='giveth.png' />
			</div>
		</div>
	</div>
)
